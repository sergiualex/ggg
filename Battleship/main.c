...
int main (void)
{
    ...
    //Boolean    wasAPlaneDestroyed = FALSE;                /* if a ship has sank */
    ...
    //             */
    //            if (wasAPlaneDestroyed) {
    //                wasAPlaneDestroyed = FALSE;
    //                targetMode = FALSE;
    //                huntMode = TRUE;
    //            }
    ...
    //        if (player == 1)
    //            wasAPlaneDestroyed = checkSunkShip(sunkPlane, !player, shipSymbol, outStream);
    //        else
